(()=>{var e={};e.id=953;e.ids=[953];e.modules={440:(e,t,i)=>{"use strict";i.r(t);i.d(t,{"default":()=>s});var a=i(1658);var n=i.n(a);const s=async e=>{const t={"type":"image/x-icon","sizes":"10089x9009"};const i=(0,a.fillMetadataSegment)(".",await e.params,"favicon.ico");return[{...t,url:i+""}]}},846:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},1024:(e,t,i)=>{"use strict";i.r(t);i.d(t,{"default":()=>x});var a=i(687);var n=i(3210);var s=i.n(n);var o=i(5773);var r=i(3526);var l=i(5885);var c=i(7e3);var d=i(5814);var p=i.n(d);var m=i(474);var u=i(9497);var h=i(8920);var g=i(8251);const y=({title:e,text:t,url:i,className:s="",size:o="md"})=>{const[d,p]=(0,n.useState)(false);const[m,u]=(0,n.useState)(false);const y=()=>{switch(o){case"sm":return"px-3 py-2 text-sm";case"lg":return"px-8 py-4 text-lg";default:return"px-6 py-3 text-base"}};const f=[{name:"Copy Link",icon:c.CQO,color:"bg-gray-600 hover:bg-gray-700",action:async()=>{try{await navigator.clipboard.writeText(i);b()}catch{x(i)}}},{name:"Twitter",icon:g.HQ1,color:"bg-blue-500 hover:bg-blue-600",action:(e,t,i)=>{const a=`${e} - ${t}`;window.open(`https://twitter.com/intent/tweet?text=${encodeURIComponent(a)}&url=${encodeURIComponent(i)}`,"_blank");b()}},{name:"LinkedIn",icon:g.IAJ,color:"bg-blue-700 hover:bg-blue-800",action:(e,t,i)=>{window.open(`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(i)}`,"_blank");b()}},{name:"Facebook",icon:g.aUl,color:"bg-blue-600 hover:bg-blue-700",action:(e,t,i)=>{window.open(`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(i)}`,"_blank");b()}},{name:"WhatsApp",icon:g.EYA,color:"bg-green-500 hover:bg-green-600",action:(e,t,i)=>{const a=`${e} - ${t} ${i}`;window.open(`https://wa.me/?text=${encodeURIComponent(a)}`,"_blank");b()}},{name:"Reddit",icon:g.onr,color:"bg-orange-600 hover:bg-orange-700",action:(e,t,i)=>{window.open(`https://reddit.com/submit?url=${encodeURIComponent(i)}&title=${encodeURIComponent(e)}`,"_blank");b()}}];const b=()=>{p(true);u(false);setTimeout(()=>p(false),2e3)};const x=e=>{const t=document.createElement("textarea");t.value=e;document.body.appendChild(t);t.select();document.execCommand("copy");document.body.removeChild(t);b()};const v=async()=>{const a={title:e,text:t,url:i};try{if(navigator.share){await navigator.share(a);b()}else{u(true)}}catch{u(true)}};return(0,a.jsxs)("div",{className:"relative",children:[(0,a.jsxs)(r.P.button,{onClick:v,className:`${y()} rounded-full font-semibold transition-all duration-300 ${d?"bg-green-500 text-white":"gradient-primary text-white hover:shadow-lg gradient-shadow"} ${s}`,whileHover:{scale:1.05,y:-2},whileTap:{scale:.98},disabled:d,children:[(0,a.jsx)(l.g,{icon:d?c.e68:c.t5Z,className:"mr-2"}),d?"Shared!":"Share"]}),(0,a.jsx)(h.N,{children:m&&(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)("div",{className:"fixed inset-0 bg-black/50 z-40",onClick:()=>u(false)}),(0,a.jsxs)(r.P.div,{initial:{opacity:0,scale:.9,y:10},animate:{opacity:1,scale:1,y:0},exit:{opacity:0,scale:.9,y:10},className:"absolute top-full mt-2 right-0 bg-main-dark/95 backdrop-blur-xl border border-white/20 rounded-xl shadow-2xl z-50 min-w-[280px]",children:[(0,a.jsxs)("div",{className:"flex items-center justify-between p-4 border-b border-white/10",children:[(0,a.jsx)("h3",{className:"text-white font-semibold",children:"Share Article"}),(0,a.jsx)("button",{onClick:()=>u(false),className:"text-gray-400 hover:text-white transition-colors",children:(0,a.jsx)(l.g,{icon:c.GRI})})]}),(0,a.jsx)("div",{className:"p-4 grid grid-cols-2 gap-3",children:f.map((n,s)=>(0,a.jsxs)(r.P.button,{onClick:()=>n.action(e,t,i),className:`flex items-center gap-3 p-3 rounded-lg text-white transition-all duration-200 ${n.color}`,initial:{opacity:0,y:10},animate:{opacity:1,y:0},transition:{delay:s*.05},whileHover:{scale:1.02},whileTap:{scale:.98},children:[(0,a.jsx)(l.g,{icon:n.icon,className:"text-lg"}),(0,a.jsx)("span",{className:"font-medium text-sm",children:n.name})]},n.name))})]})]})})]})};const f=y;const b=({params:e})=>{const{slug:t}=(0,n.use)(e);const i=(0,u.t1)(t);const[d,h]=(0,n.useState)(false);if(!i){(0,o.notFound)()}const g=()=>{const e=JSON.parse(localStorage.getItem("savedBlogPosts")||"[]");const i=e.includes(t);if(i){const i=e.filter(e=>e!==t);localStorage.setItem("savedBlogPosts",JSON.stringify(i));h(false)}else{e.push(t);localStorage.setItem("savedBlogPosts",JSON.stringify(e));h(true)}};s().useEffect(()=>{const e=JSON.parse(localStorage.getItem("savedBlogPosts")||"[]");h(e.includes(t))},[t]);const y=e=>{return e.split("\n\n").map((e,t)=>{if(e.startsWith("##")){return(0,a.jsx)(r.P.h2,{className:"text-2xl font-bold text-gradient-primary mt-8 mb-4",initial:{opacity:0,x:-20},whileInView:{opacity:1,x:0},transition:{delay:t*.1},children:e.replace("## ","")},t)}if(e.startsWith("1.")||e.startsWith("2.")||e.startsWith("3.")){const i=e.split("\n").filter(e=>e.match(/^\d+\./));return(0,a.jsx)(r.P.ol,{className:"list-decimal list-inside space-y-2 mb-6 ml-4",initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},transition:{delay:t*.1},children:i.map((e,t)=>(0,a.jsx)("li",{className:"text-gray-300 leading-relaxed",children:e.replace(/^\d+\.\s*/,"")},t))},t)}return(0,a.jsx)(r.P.p,{className:"text-gray-300 leading-relaxed mb-6 text-lg",initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},transition:{delay:t*.1},children:e},t)})};return(0,a.jsxs)("div",{className:"min-h-screen bg-gradient-to-br from-main-dark via-main-dark-secondary to-main-dark relative overflow-hidden",children:[(0,a.jsxs)("div",{className:"absolute inset-0 opacity-20",children:[(0,a.jsx)("div",{className:"absolute top-32 right-20 w-64 h-64 bg-gradient-secondary/20 rounded-full blur-3xl floating"}),(0,a.jsx)("div",{className:"absolute bottom-40 left-16 w-80 h-80 bg-gradient-primary/15 rounded-full blur-3xl floating",style:{animationDelay:"3s"}})]}),(0,a.jsx)(r.P.header,{className:"sticky top-0 z-50 backdrop-blur-lg bg-main-dark/80 border-b border-white/10",initial:{y:-100},animate:{y:0},transition:{duration:.5},children:(0,a.jsx)("div",{className:"container mx-auto px-6 py-4",children:(0,a.jsxs)(p(),{href:"/#blog",className:"inline-flex items-center gap-3 text-gradient-primary hover-text-gradient-tertiary transition-colors duration-300",children:[(0,a.jsx)(l.g,{icon:c.CeG}),(0,a.jsx)("span",{className:"font-semibold",children:"Back to Blog"})]})})}),(0,a.jsxs)("main",{className:"container mx-auto px-6 py-12 relative z-10",children:[(0,a.jsxs)(r.P.div,{className:"max-w-4xl mx-auto mb-12",initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.6},children:[(0,a.jsx)(r.P.div,{className:"mb-6",whileHover:{scale:1.05},transition:{duration:.2},children:(0,a.jsx)("span",{className:"px-4 py-2 text-sm theme-gradient-primary-tertiary text-black rounded-full font-semibold",children:i.category})}),(0,a.jsx)(r.P.h1,{className:"text-4xl md:text-5xl lg:text-6xl font-bold mb-6 gradient-text leading-tight",initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{delay:.2,duration:.6},children:i.title}),(0,a.jsxs)(r.P.div,{className:"flex flex-wrap items-center gap-6 text-gray-400 mb-8",initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{delay:.4,duration:.6},children:[(0,a.jsxs)("div",{className:"flex items-center gap-2",children:[(0,a.jsx)(l.g,{icon:c.X46,className:"text-gradient-primary"}),(0,a.jsx)("span",{children:i.author})]}),(0,a.jsxs)("div",{className:"flex items-center gap-2",children:[(0,a.jsx)(l.g,{icon:c.BEE,className:"text-gradient-primary"}),(0,a.jsx)("span",{children:i.date})]}),i.readTime&&(0,a.jsxs)("div",{className:"flex items-center gap-2",children:[(0,a.jsx)(l.g,{icon:c.a$,className:"text-gradient-primary"}),(0,a.jsx)("span",{children:i.readTime})]})]}),(0,a.jsxs)(r.P.div,{className:"flex gap-4 mb-8",initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{delay:.6,duration:.6},children:[(0,a.jsx)(f,{title:i.title,text:i.excerpt,url:false?0:`https://stephanelkhoury.com/blog/${i.slug}`,size:"md"}),(0,a.jsxs)(r.P.button,{onClick:g,className:`px-6 py-3 rounded-full font-semibold transition-all duration-300 ${d?"theme-gradient-tertiary-secondary text-white":"bg-white/10 backdrop-blur-sm text-white hover:bg-white/20"}`,whileHover:{scale:1.05,y:-2},whileTap:{scale:.98},children:[(0,a.jsx)(l.g,{icon:c.G06,className:"mr-2"}),d?"Saved":"Save"]})]})]}),(0,a.jsx)(r.P.div,{className:"max-w-5xl mx-auto mb-12 rounded-2xl overflow-hidden",initial:{opacity:0,scale:.95},animate:{opacity:1,scale:1},transition:{delay:.8,duration:.6},children:(0,a.jsxs)("div",{className:"relative h-[400px] md:h-[500px] lg:h-[600px]",children:[(0,a.jsx)(m["default"],{src:i.image,alt:i.title,fill:true,className:"object-cover",priority:true}),(0,a.jsx)("div",{className:"absolute inset-0 bg-gradient-to-t from-black/40 to-transparent"})]})}),(0,a.jsxs)(r.P.article,{className:"max-w-4xl mx-auto",initial:{opacity:0},animate:{opacity:1},transition:{delay:1,duration:.6},children:[(0,a.jsx)(r.P.div,{className:"mb-12 p-8 gradient-bg-subtle rounded-2xl backdrop-blur-sm border border-white/10",initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},transition:{duration:.6},children:(0,a.jsx)("p",{className:"text-xl text-gray-200 leading-relaxed italic",children:i.excerpt})}),(0,a.jsx)("div",{className:"prose prose-lg prose-invert max-w-none",children:i.fullContent?y(i.fullContent):(0,a.jsx)(r.P.p,{className:"text-gray-300 leading-relaxed text-lg",initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},transition:{duration:.6},children:"Full content coming soon..."})}),i.tags&&i.tags.length>0&&(0,a.jsxs)(r.P.div,{className:"mt-12 pt-8 border-t border-white/10",initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},transition:{duration:.6},children:[(0,a.jsxs)("div",{className:"flex items-center gap-2 mb-4",children:[(0,a.jsx)(l.g,{icon:c._2z,className:"text-gradient-primary"}),(0,a.jsx)("span",{className:"text-gray-400 font-semibold",children:"Tags:"})]}),(0,a.jsx)("div",{className:"flex flex-wrap gap-3",children:i.tags.map((e,t)=>(0,a.jsx)(r.P.span,{className:"px-3 py-1 bg-white/10 backdrop-blur-sm text-gray-300 rounded-full text-sm hover:bg-white/20 transition-colors duration-300 cursor-pointer",initial:{opacity:0,scale:0},whileInView:{opacity:1,scale:1},transition:{delay:t*.1,duration:.3},whileHover:{scale:1.05},children:e},e))})]})]}),(0,a.jsx)(r.P.div,{className:"max-w-4xl mx-auto mt-16 pt-8 border-t border-white/10",initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},transition:{duration:.6},children:(0,a.jsx)("div",{className:"text-center",children:(0,a.jsxs)(p(),{href:"/#blog",className:"inline-flex items-center gap-3 px-8 py-4 theme-gradient-primary-tertiary text-black font-bold rounded-full hover:shadow-lg theme-shadow-primary transition-all duration-300 transform hover:scale-105 hover:translate-y-[-2px]",children:[(0,a.jsx)(l.g,{icon:c.CeG}),"Back to All Articles"]})})})]})]})};const x=b},3033:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},3295:e=>{"use strict";e.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},3829:(e,t,i)=>{Promise.resolve().then(i.bind(i,9427))},3873:e=>{"use strict";e.exports=require("path")},4101:(e,t,i)=>{Promise.resolve().then(i.bind(i,1024))},9121:e=>{"use strict";e.exports=require("next/dist/server/app-render/action-async-storage.external.js")},9294:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-async-storage.external.js")},9365:(e,t,i)=>{"use strict";i.r(t);i.d(t,{GlobalError:()=>r.a,__next_app__:()=>v,pages:()=>f,routeModule:()=>w,tree:()=>y});var a=i(5239);var n=i.n(a);var s=i(8088);var o=i(8170);var r=i.n(o);var l=i(893);var c=i.n(l);var d={};for(const e in l)if(["default","tree","pages","GlobalError","__next_app__","routeModule"].indexOf(e)<0)d[e]=()=>l[e];i.d(t,d);const p=()=>Promise.resolve().then(i.bind(i,4431));const m=()=>Promise.resolve().then(i.t.bind(i,7398,23));const u=()=>Promise.resolve().then(i.t.bind(i,9999,23));const h=()=>Promise.resolve().then(i.t.bind(i,5284,23));const g=()=>Promise.resolve().then(i.bind(i,9427));const y={children:["",{children:["blog",{children:["[slug]",{children:["__PAGE__",{},{page:[g,"/Users/stephanelkhoury/Documents/GitHub/stephanelkhoury/src/app/blog/[slug]/page.tsx"]}]},{}]},{metadata:{icon:[async e=>(await Promise.resolve().then(i.bind(i,440))).default(e)],apple:[],openGraph:[],twitter:[],manifest:undefined}}]},{"layout":[p,"/Users/stephanelkhoury/Documents/GitHub/stephanelkhoury/src/app/layout.tsx"],"not-found":[m,"next/dist/client/components/not-found-error"],"forbidden":[u,"next/dist/client/components/forbidden-error"],"unauthorized":[h,"next/dist/client/components/unauthorized-error"],metadata:{icon:[async e=>(await Promise.resolve().then(i.bind(i,440))).default(e)],apple:[],openGraph:[],twitter:[],manifest:undefined}}]}.children;const f=["/Users/stephanelkhoury/Documents/GitHub/stephanelkhoury/src/app/blog/[slug]/page.tsx"];const b=i;const x=()=>Promise.resolve();const v={require:b,loadChunk:x};const w=new a.AppPageRouteModule({definition:{kind:s.RouteKind.APP_PAGE,page:"/blog/[slug]/page",pathname:"/blog/[slug]",bundlePath:"",filename:"",appPaths:[]},userland:{loaderTree:y}})},9427:(e,t,i)=>{"use strict";i.r(t);i.d(t,{"default":()=>s});var a=i(2907);var n=i.n(a);const s=(0,a.registerClientReference)(function(){throw new Error("Attempted to call the default export of \"/Users/stephanelkhoury/Documents/GitHub/stephanelkhoury/src/app/blog/[slug]/page.tsx\" from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.")},"/Users/stephanelkhoury/Documents/GitHub/stephanelkhoury/src/app/blog/[slug]/page.tsx","default")},9497:(e,t,i)=>{"use strict";i.d(t,{A5:()=>a,t1:()=>n});const a=[{title:"The Future of AI in Music Production",excerpt:"Exploring how artificial intelligence is revolutionizing the way we create and produce music, from automated composition to intelligent mixing.",fullContent:`Artificial Intelligence is transforming the music industry in unprecedented ways. From AI-powered composition tools to intelligent mixing algorithms, technology is reshaping how we create, produce, and consume music.
...
The journey from university project to production platform has been challenging but incredibly rewarding, teaching me that great products are built through iteration, user feedback, and persistent improvement.`,date:"March 25, 2025",category:"Startup",image:"/blog/university-to-production.jpg",link:"/blog/dream-to-production",slug:"dream-to-production",readTime:"16 min read",tags:["Startup","Product Development","Music Technology","AI"],author:"Stephan El Khoury"}];const n=e=>{return a.find(t=>t.slug===e)};const s=()=>{return a.map(e=>e.slug||"").filter(Boolean)};const o=(e=3)=>{return a.slice(0,e)};const r=e=>{return a.filter(t=>t.category===e)}},9551:e=>{"use strict";e.exports=require("url")}};var t=require("../../../webpack-runtime.js");t.C(e);var i=e=>t(t.s=e);var a=t.X(0,[447,947,810,251,41],()=>i(9365));module.exports=a})();