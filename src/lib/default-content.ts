...
export const defaultSystems = [
  ...
  },
  {
    ...
    shortDescription: 'Typed JavaScript for maintainable applications and APIs.',
    experience:
      'I use TypeScript across frontend and backend projects to ship safer code with stronger tooling and long-term maintainability.',
    projectLinks: ['/upcoming-projects/01-modern-ecommerce-platform', '/upcoming-projects/03-project-management-dashboard'],
    certificateLinks: [],
    resourceLinks: ['https://www.typescriptlang.org/docs/'],
    sortOrder: 11,
    isActive: true,
  },
  {
    ...
    shortDescription: 'Type-safe ORM and schema workflow for modern databases.',
    experience:
      'I use Prisma for schema design, migrations, and strongly typed data access in production SaaS and portfolio applications.',
    projectLinks: ['/upcoming-projects/01-modern-ecommerce-platform', '/upcoming-projects/03-project-management-dashboard'],
    certificateLinks: [],
    resourceLinks: ['https://www.prisma.io/docs'],
    sortOrder: 12,
    isActive: true,
  },
  {
    ...
    shortDescription: 'Utility-first styling system for fast UI development.',
    experience:
      'I build responsive, scalable design systems and application interfaces with Tailwind CSS in React and Next.js projects.',
    projectLinks: ['/upcoming-projects/03-project-management-dashboard'],
    certificateLinks: [],
  ...
  },
  {
    ...
    shortDescription: 'Deployment platform for Next.js, APIs, and serverless workloads.',
    experience:
      'I deploy and operate full-stack applications on Vercel with environment management, previews, and production rollouts.',
    projectLinks: ['/upcoming-projects/07-restful-api-platform'],
    certificateLinks: [],
    resourceLinks: ['https://vercel.com/docs'],
    sortOrder: 14,
    isActive: true,
  },
  {
    ...
    shortDescription: 'CI/CD automation for testing, build, and deployment workflows.',
    experience:
      'I create and maintain GitHub Actions pipelines for automated checks, deployment gates, and release workflows.',
    projectLinks: ['/upcoming-projects/08-dockerized-microservices-platform'],
    certificateLinks: [],
    resourceLinks: ['https://docs.github.com/actions'],
    sortOrder: 15,
    isActive: true,
  },
  {
    ...
    shortDescription: 'Document database for flexible and high-throughput applications.',
    experience:
      'I use MongoDB in real-time and API-heavy products where schema flexibility and fast iteration are important.',
    projectLinks: ['/upcoming-projects/02-realtime-chat-application'],
    certificateLinks: [],
    resourceLinks: ['https://www.mongodb.com/docs/'],
    sortOrder: 16,
    isActive: true,
  },
  {
    ...
    shortDescription: 'In-memory datastore for caching, queues, and realtime systems.',
    experience:
      'I use Redis for caching, pub/sub, and queue-backed workflows to improve throughput and reliability.',
    projectLinks: ['/upcoming-projects/02-realtime-chat-application', '/upcoming-projects/03-project-management-dashboard'],
    certificateLinks: [],
    resourceLinks: ['https://redis.io/docs/latest/'],
    sortOrder: 17,
    isActive: true,
  },
] as const;
