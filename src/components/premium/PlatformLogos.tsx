...
export default function PlatformLogos({ items }: { items: LogoItem[] }) {
  ...
  return (
    <section id="platforms" className="py-24 bg-gradient-to-b from-zinc-50 to-white dark:from-zinc-950 dark:to-zinc-950 border-t border-zinc-200/60 dark:border-zinc-900/60">
      <div className="max-w-7xl mx-auto px-6 md:px-12 overflow-hidden">
        <div className="text-center max-w-2xl mx-auto mb-14">
          ...
          >
            ...
            <p className="text-zinc-600 dark:text-zinc-300 text-lg">Hover to pause. Click any logo to view my experience with that platform.</p>
          </motion.div>
        </div>
